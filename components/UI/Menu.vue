<template>
    <div class="burger-wrapper">
        <div
            class="burger-wrapper__navigation"
            :class="isActive ? 'activeNavigation' : ''"
        >
            <div class="burger-wrapper__navigation-menu">
                <div
                    class="burger-wrapper__navigation-links"
                    @mouseleave="mouseLeaveHandler"
                >
                    <NuxtLink
                        to="/"
                        class="linkFont"
                        :class="isActive ? 'textActive' : 'textInactive'"
                        @click="menuToggle"
                    ...
                    <NuxtLink
                        ...
                        :class="isActive ? 'textActive' : 'textInactive'"
                        @click="menuToggle"
                        @mouseover="mouseOverHandler('Hotel')"
                        >Hotel
                    </NuxtLink>
                    <NuxtLink
                        to="/hotel/123"
                        ...
                        :class="isActive ? 'textActive' : 'textInactive'"
                        @click="menuToggle"
                        @mouseover="mouseOverHandler('Shotel')"
                        >SHotel
                    </NuxtLink>
                </div>
            ...
            <div class="burger-wrapper__navigation-footer">
                <div
                    class="burger-wrapper__navigation-footer-item"
                    :class="isActive ? 'textActive' : 'textInactive'"
                >
                    <p>INSTAGRAM</p>
                    <img
        ...
        <div class="burger-wrapper__menu" @click="menuToggle">
            ...
            <div
                class="burger-wrapper__menu-dot"
                :class="isActive ? 'activeDotClose' : ''"
            ></div>
            <div
                class="burger-wrapper__menu-dot"
                :class="isActive ? 'activeDotLong' : ''"
            ></div>
            <div class="burger-wrapper__menu-dot"></div>
            <div class="burger-wrapper__menu-dot"></div>
            <div
